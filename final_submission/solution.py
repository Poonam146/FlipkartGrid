...
# 5. Drop timestamp and helper datetime
...
for fold, (train_idx, val_idx) in enumerate(kf.split(X, y)):
    ...
    # 10. Use CatBoost with specified hyperparameters
    ...
    # Predict validation fold (for CV calculation)
...
# 8. Print overall CV R2 score
cv_r2 = r2_score(y, oof_preds)
print(f"\n======================================")
print(f"Overall Out-of-Fold CV R2 Score: {cv_r2:.6f}")
print(f"======================================\n")
...
np.save("catboost_oof.npy", oof_preds)


# 11. Create submission_v2.csv with columns: Index, demand
submission = pd.DataFrame({
    'Index': test['Index'],
    'demand': test_preds_avg
})

# 12. Save submission_v2.csv in project root
